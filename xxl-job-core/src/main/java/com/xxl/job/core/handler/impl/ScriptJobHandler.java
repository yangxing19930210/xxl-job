...
public class ScriptJobHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        // make script file
        String scriptFileName = XxlJobFileAppender.getGlueSrcPath().concat(File.separator).concat(String.valueOf(jobId))
            .concat("_").concat(String.valueOf(glueUpdatetime)).concat(glueType.getSuffix());
