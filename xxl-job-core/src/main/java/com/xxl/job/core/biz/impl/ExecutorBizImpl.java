...
public class ExecutorBizImpl implements ExecutorBiz {
    ...
    public ReturnT<String> run(TriggerParam triggerParam) {
        ...
        if (GlueTypeEnum.BEAN == glueTypeEnum) {
            ...
            // valid old jobThread
            if (jobThread != null
                && !(jobThread.getHandler() instanceof ScriptJobHandler && ((ScriptJobHandler)jobThread.getHandler())
    ...
    public ReturnT<LogResult> log(LogParam logParam) {
        ...
        String logFileName =
            XxlJobFileAppender.makeLogFileName(new Date(logParam.getLogDateTim()), logParam.getLogId());
